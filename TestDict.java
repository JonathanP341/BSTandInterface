    ...
    public static void main(String[] args) {
        ...
        if (alltests || test == 6 || test == 7 || test == 8 || test == 9)
            try {
                ...
                System.out.println(words[1] + "aaaa");
                ...
                System.out.println("Test 6 failedddd");
            }
        ...
        if (alltests || test == 7)
            try {
                ...
                System.out.println("Test 7 faileddd");
            }
        ...
        if (alltests || test == 8)
            try {
                ...
                System.out.println("Test 8 faileddd");
            }
        ...
        if (alltests || test == 9)
            try {
                ...
                System.out.println("Test 9 faileddd");
            }
        ...
        try {
            ...
            if (alltests || test == 13)
                ...
                try {
                    ...
                    System.out.println("Test 13 failedd");
                }
                catch(DictionaryException e) {
                    System.out.println("Test 13 passed");
                }
                catch (Exception e) {
                    System.out.println("Test 13 faileddd");
                }

            if (alltests || test == 14)
                // Test the predecessor method
                try {
                    Record record = dictionary.get(new Key("pony",TEXT));

                    rec = dictionary.predecessor(new Key("pony",TEXT)); //Error here
                    ...
                    System.out.println("Null pointer problem"); //Error heree
                } catch (Exception e) {
